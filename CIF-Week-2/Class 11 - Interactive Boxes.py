...
text_surface = my_font.render("Welcome!", True, (255, 255, 255))
box1_x = 0
box1_y = 100
box2_x = width // 2
box2_y = height // 2
...
while True:
    ...
    if rect1.colliderect(rect2):
        my_font2 = pygame.font.SysFont("helvetica", 40)
        text_surface2 = my_font.render("You are on the green button...", True, (255, 255, 197))
        screen.blit(text_surface2, (20, 740))
        pygame.draw.rect(screen, blue, rect2)
        box1_x = box1_x - box1_x_change
        box1_y = box1_y - box1_y_change
