...
my_font3 = pygame.font.SysFont("arial", 60)
text_surface3 = my_font3.render("You Escaped!", True, (0, 0, 0))
my_font4 = pygame.font.SysFont("arial", 30)
text_surface4 = my_font4.render("Failed...", True, (255, 75, 75))
my_font5 = pygame.font.SysFont("times new roman", 25)
text_surface5 = my_font5.render("Goal", True, (255, 75, 75))
player_x = 15 #change to 15 later
player_y = 100#change to 100 later
player_x_change = 0
player_y_change = 0
player_speed = 9
enemy_y = 60
...
player_speed = float(input("Enter the speed of the player. (8-15) (10 recommended)"))
if player_speed < 8:
    player_speed = 8
elif player_speed > 15:
    player_speed = 15
enemy_y_change = float(input("Enter the speed of the top-left enemies. (5-15) (10 recommended)"))
if enemy_y_change < 5:
    enemy_y_change = 5
elif enemy_y_change > 15:
    enemy_y_change = 15
...
if enemy_y2_change < 7:
    ...
    enemy_y2_change = 15
enemy_y3_change = float(input("Enter the speed of the bottom-right enemies. (5-15) (10 recommended) The game window will load after this."))
if enemy_y3_change < 5:
    enemy_y3_change = 5
...
while runtime:
    ...
    wall11 = pygame.Rect(90, 600, 330, 30)
    wall12 = pygame.Rect(60, 600, 30, 210)
    wall13 = pygame.Rect(420, 720, 30, 180)
    wall_list = [wall1, wall2, wall3, wall4, wall5, wall6, wall7, wall8, wall9, wall10, wall11, wall12, wall13]
    ...
    if player.colliderect(goal):
        screen.blit(text_surface3, (520, 390))
    ...
    enemy1 = pygame.Rect(120, enemy_y, 30, 30)
    enemy2 = pygame.Rect(210, enemy_y, 30, 30)
    ...
    enemy4 = pygame.Rect(120, enemy_y2, 30, 30)
    enemy5 = pygame.Rect(210, enemy_y2, 30, 30)
    enemy6 = pygame.Rect(300, enemy_y2, 30, 30)
    enemy7 = pygame.Rect(390, enemy_y2, 30, 30)
